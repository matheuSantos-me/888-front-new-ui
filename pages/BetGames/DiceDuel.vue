...
<el-row class="width-full">
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    <div class="panel-heading games-navigation p-0 height-5" :class="{'bg-orange12-page': layoutType == 'layout2'}">
      ...
      <MiniHeader v-else :miniGameType="31" />
    </div>
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
      ...
      <div class="bg-black-darker">
        <div class="panel-collapse collapse in playerbox3 lotusbg position-relative" style="margin:0px; padding:0px;" id="bet-game-frame-container" ref="betgameframecontainer">
					<iframe style="width:100%; height:646px;" frameborder="0" scrolling="no" :src="'/html/index11.html'" name="datacont1" id="myframe" class="bet-game-frame"></iframe>
      ...
      <div class="col-md-12 m-b-15" :class="isMobile ? 'p-0' : 'p-t-0'">
        <div class="col-md-12" :class="[{'p-0': isMobile}, `v-box1-agero-prematch-${themeType}`]">
                    ...
                    <tr>
                      <td v-if="!isShowMobile" width="360">
                          <div class=" m-l-10 pull-left table-td-valign-middle">
                            <div class="f-s-25 p-l-20"><i class="fa fa-star m-r-8 text-orange11"></i><strong>DICE DUEL</strong></div>
                            <div class="f-s-12 p-l-50 text-gray">3분마다 2개의 주사위를 굴린 결과로 하는 게임</div>
                          </div>
                      </td>
          ...
          <div class="col-md-12" :class="[{'p-0': isMobile}, `v-box2-agero-${themeType}`]">
              <ul class="col-md-12 width-full m-b-1 p-0" :class="{'p-l-2 m-t-12': !isMobile}">
                <button type="button" class="btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg text-white f-s-14 text-left p-10" data-toggle="collapse" data-target="#Collapse_1">
                  <i class="fa fa-chevron-circle-down m-r-5 text-grey901"></i><strong><span>주사위 - (승/무/패)</span></strong>
                </button>
              </ul>
              <div class="panel-collapse col-md-12 m-0 p-0 collapse show" id="Collapse_1">
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub1-agero'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(0, 2.25)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>빨간색 주사위 승리</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>2.25</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub1-agero'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(1, 5.7)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>무승부</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>5.70</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub1-agero'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(2, 2.25)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>파란색 주사위 승리</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>2.25</span></strong></li>
                      </ul>
                    </button>
                  </li>
              ...
              <ul class="col-md-12 width-full m-b-1 p-0" :class="{'p-l-2  m-t-12': !isMobile}">
                <button type="button" class="btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg text-white f-s-14 text-left p-10" data-toggle="collapse" data-target="#Collapse_2">
                  <i class="fa fa-chevron-circle-down m-r-5 text-grey901"></i><strong><span>주사위 - (홀/짝)</span></strong>
                </button>
              </ul>
                ...
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(3, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>빨간색 주사위 홀수</span></li>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(4, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>빨간색 주사위 짝수</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.90</span></strong></li>
                      </ul>
                    </button>
                  </li>
                ...
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(5, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>파란색 주사위 홀수</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.90</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(6, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>파란색 주사위 짝수</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.90</span></strong></li>
                      </ul>
                    </button>
                  </li>
                ...
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(7, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위 총 합이 홀수</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.90</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(8, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위 총 합이 짝수</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.90</span></strong></li>
                      </ul>
                    </button>
                  </li>
              ...
              <ul class="col-md-12 width-full m-b-1 p-0" :class="{'p-l-2  m-t-12': !isMobile}">
                <button type="button" class="btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg text-white f-s-14 text-left p-10" data-toggle="collapse" data-target="#Collapse_3">
                  <i class="fa fa-chevron-circle-down m-r-5 text-grey901"></i><strong><span>주사위 - (오버/언더)</span></strong>
                </button>
              </ul>
              <div class="panel-collapse col-md-12 m-0 p-0 collapse show" id="Collapse_3">
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(9, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>빨간색 주사위 3.5 오버</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.90</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(10, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>빨간색 주사위 3.5 언더</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.90</span></strong></li>
                      </ul>
                    </button>
                  </li>
                ...
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(11, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>파란색 주사위 3.5 오버</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.90</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(12, 1.9)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>파란색 주사위 3.5 언더</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.90</span></strong></li>
                      </ul>
                    </button>
                  </li>
                ...
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(13, 1.14)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 4.5 오버</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.14</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(14, 5.7)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 4.5 언더</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>5.70</span></strong></li>
                      </ul>
                    </button>
                  </li>
                ...
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(15, 1.3)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 5.5 오버</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.30</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(16, 3.4)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 5.5 언더</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>3.40</span></strong></li>
                      </ul>
                    </button>
                  </li>
                </ul>
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(17, 1.62)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 6.5 오버</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.62</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(18, 2.25)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 6.5 언더</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>2.25</span></strong></li>
                      </ul>
                    </button>
                  </li>
                ...
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(19, 2.25)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 7.5 오버</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>2.25</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(20, 1.62)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 7.5 언더</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.62</span></strong></li>
                      </ul>
                    </button>
                  </li>
                ...
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(21, 3.4)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 8.5 오버</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>3.40</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(22, 1.3)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 8.5 언더</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.30</span></strong></li>
                      </ul>
                    </button>
                  </li>
                ...
                <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(23, 5.7)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 9.5 오버</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>5.70</span></strong></li>
                      </ul>
                    </button>
                  </li>
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="`btn-${themeType}`" @click="onClickBetButton(24, 1.14)">
                      <ul class="list-box-g-agero col-md-12 m-3">
                        <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>두 주사위의 총 합이 9.5 언더</span></li>
                        <li class="hva-txt text-right text-white f-s-15 p-r-10"><strong><span>1.14</span></strong></li>
                      </ul>
                    </button>
                  </li>
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">벳게임 주사위결투 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "BetGameDiceDuel"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      BetGameDiceDuelBet: "getBetGameDiceDuelBet",
  ...
  data() {
    return {
      ...
      gameName: "벳게임 주사위결투",                                   // 게임명
      gameType: "BetGameDiceDuel",                                 // 게임타입
      betLogs: null,                                              // 배팅내역
      isCheck: true,
      initFrameWidth: 0,
      isShowMobile: false
  ...
  watch: {
    BetGameDiceDuelBet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.BetGameDiceDuel.gameStatus_auto || val.BetGameDiceDuel.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.BetGameDiceDuel.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'BetGames-DiceDuel')
    ...
    let levelSetting = this.gameSettings.BetGameDiceDuel.levelSetting[this.gameSettings.BetGameDiceDuel.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BetGameDiceDuel.gameStatus_auto | this.gameSettings.BetGameDiceDuel.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BetGameDiceDuel.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameBetGameDiceDuelRound'),
    mainService.on('miniGameBetGameDiceDuelRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
