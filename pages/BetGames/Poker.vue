...
<el-row class="width-full">
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    <div class="panel-heading games-navigation p-0 height-5" :class="{'bg-orange12-page': layoutType == 'layout2'}">
      ...
      <MiniHeader v-else :miniGameType="28" />
    </div>
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
      ...
      <div class="bg-black-darker">
        <div class="panel-collapse collapse in playerbox3 lotusbg position-relative" style="margin:0px; padding:0px;" id="bet-game-frame-container" ref="betgameframecontainer">
					<iframe style="width:100%; height:646px;" frameborder="0" scrolling="no" :src="'/html/index5.html'" name="datacont1" id="myframe" class="bet-game-frame"></iframe>
      ...
      <div class="col-md-12 m-b-15" :class="isMobile ? 'p-0' : 'p-t-0'">
        <div class="col-md-12" :class="[{'p-0': isMobile}, `v-box1-agero-prematch-${themeType}`]">
                    ...
                    <tr>
                      <td v-if="!isShowMobile" width="360">
                        <div class=" m-l-10 pull-left table-td-valign-middle">
                          <div class="f-s-25 p-l-20"><i class="fa fa-star m-r-8 text-orange11"></i><strong id="game_title">LIVE POKER</strong></div>
                      ...
                      <td width="215" class="display-none position-relative">
                          <span class="flip-clock-wrapper display-none">
          ...
          <div v-if="currentGameInfo" class="col-md-12 " :class="[{'p-0': isMobile}, `v-box2-agero-${themeType}`]">
            <ul class="col-md-12 width-full m-t-12 m-b-1 p-0" :class="{'p-l-2': !isMobile}">
              <button type="button" class="btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg text-white f-s-14 text-left p-10" data-toggle="collapse" data-target="#Collapse_1">
                <i class="fa fa-chevron-circle-down m-r-5 text-grey901"></i><strong><span>플레이어(화면 오른쪽부터 1,2,3,4,5,6 순 입니다.)</span></strong>
              </button>
            </ul>
            <div class="panel-collapse col-md-12 m-0 p-0 collapse show" id="Collapse_1">
              <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub1-agero'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[0].status != 'active'}]" @click="onClickBetButton(0, currentGameInfo.odds[0].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>플레이어 1 승리</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[0].status == 'active'">{{currentGameInfo.odds[0].value}}</span>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub1-agero'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[1].status != 'active'}]" @click="onClickBetButton(1, currentGameInfo.odds[1].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>플레이어 2 승리</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[1].status == 'active'">{{currentGameInfo.odds[1].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub1-agero'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[2].status != 'active'}]" @click="onClickBetButton(2, currentGameInfo.odds[2].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>플레이어 3 승리</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[2].status == 'active'">{{currentGameInfo.odds[2].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
              ...
              <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub1-agero'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[3].status != 'active'}]" @click="onClickBetButton(3, currentGameInfo.odds[3].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>플레이어 4 승리</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[3].status == 'active'">{{currentGameInfo.odds[3].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub1-agero'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[4].status != 'active'}]" @click="onClickBetButton(4, currentGameInfo.odds[4].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>플레이어 5 승리</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[4].status == 'active'">{{currentGameInfo.odds[4].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub1-agero'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[5].status != 'active'}]" @click="onClickBetButton(5, currentGameInfo.odds[5].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>플레이어 6 승리</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[5].status == 'active'">{{currentGameInfo.odds[5].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
            ...
            <ul class="col-md-12 width-full m-t-12 m-b-1 p-0" :class="{'p-l-2': !isMobile}">
              <button type="button" class="btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg text-white f-s-14 text-left p-10" data-toggle="collapse" data-target="#Collapse_2">
                <i class="fa fa-chevron-circle-down m-r-5 text-grey901"></i><strong><span>조합</span></strong>
              </button>
            </ul>
            <div class="panel-collapse col-md-12 m-0 p-0 collapse show" id="Collapse_2">
              <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[6].status != 'active'}]" @click="onClickBetButton(6, currentGameInfo.odds[6].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>높은카드</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[6].status == 'active'">{{currentGameInfo.odds[6].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[7].status != 'active'}]" @click="onClickBetButton(7, currentGameInfo.odds[7].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>원페어</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[7].status == 'active'">{{currentGameInfo.odds[7].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
              ...
              <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[8].status != 'active'}]" @click="onClickBetButton(8, currentGameInfo.odds[8].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>투페어</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[8].status == 'active'">{{currentGameInfo.odds[8].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[9].status != 'active'}]" @click="onClickBetButton(9, currentGameInfo.odds[9].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>트리플</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[9].status == 'active'">{{currentGameInfo.odds[9].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
              ...
              <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[10].status!== 'active'}]" @click="onClickBetButton(10, currentGameInfo.odds[10].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>스트레이트</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[10].status == 'active'">{{currentGameInfo.odds[10].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[11].status!== 'active'}]" @click="onClickBetButton(11, currentGameInfo.odds[11].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>플러쉬</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[11].status == 'active'">{{currentGameInfo.odds[11].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
              ...
              <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[12].status!== 'active'}]" @click="onClickBetButton(12, currentGameInfo.odds[12].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>풀하우스</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[12].status == 'active'">{{currentGameInfo.odds[12].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[13].status!== 'active'}]" @click="onClickBetButton(13, currentGameInfo.odds[13].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>포카드</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[13].status == 'active'">{{currentGameInfo.odds[13].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
              ...
              <ul class="list-box-g-agero col-md-12 width-full m-t-0">
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[14].status!== 'active'}]" @click="onClickBetButton(14, currentGameInfo.odds[14].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>스트레이트 플러쉬</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[14].status == 'active'">{{currentGameInfo.odds[14].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
                  ...
                  <li :class="isMobile ? 'hva_bt_sub' : 'hva_bt_sub2'">
                    <button type="button" class="btn btn-btn btn-sports btn-block f-s-13" :class="[`btn-${themeType}`, {'disabled': !isBetAvailable || currentGameInfo.odds[15].status!== 'active'}]" @click="onClickBetButton(15, currentGameInfo.odds[15].value)">
                        <ul class="list-box-g-agero col-md-12 m-3">
                          <li class="hva-txt text-left text-gray"><i class="fa fa-star-o m-r-5 text-white"></i><span>로얄 스트레이트 플러쉬</span></li>
                          <li class="hva-txt text-right text-white f-s-15 p-r-10">
                            <strong>
                              <span v-if="isBetAvailable && currentGameInfo.odds[15].status == 'active'">{{currentGameInfo.odds[15].value}}</span>
                              <span v-else><img :src="'/image/mini/ajax-loader.gif'"></span>
                            </strong>
                          </li>
                        </ul>
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">벳게임 홀덤포커 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "BetGamePoker"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      BetGamePokerBet: "getBetGamePokerBet",
  ...
  data() {
    return {
      ...
      gameName: "벳게임 홀덤포커",                                   // 게임명
      gameType: "BetGamePoker",                                 // 게임타입
      betLogs: null,                                              // 배팅내역
      isCheck: true,
      initFrameWidth: 0,
      isShowMobile: false
  ...
  watch: {
    ...
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.BetGamePoker.gameStatus_auto || val.BetGamePoker.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.BetGamePoker.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'BetGames-Poker')
    ...
    let levelSetting = this.gameSettings.BetGamePoker.levelSetting[this.gameSettings.BetGamePoker.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BetGamePoker.gameStatus_auto | this.gameSettings.BetGamePoker.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BetGamePoker.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameBetGamePokerRound'),
    mainService.on('miniGameBetGamePokerRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameBetGamePokerOdds')
    mainService.on('miniGameBetGamePokerOdds', (state) => {
