  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
          ...
          <div class="list-box-g-agero col-md-12 width-full m-b-10 clockbox bg-black16">
            <div class="pull-left table-td-valign-middle" :class="isMobile ? 'm-t-20 m-l-0' : 'm-t-13 m-l-10'">
              <div v-if="!isMobile" class="f-s-25 p-l-20">
                ...
                <strong>MGM(바카라2)</strong> - <strong class="text-orange11">{{currentGameInfo ? currentGameInfo.roundNumber : 0}}</strong><strong>회차</strong>
              </div>
          ...
          <div class="col-md-12" :class="`v-box2-agero-${themeType}`">
            <ul class="list-box-g-agero col-md-12 text-ellipsis m-t-20 m-b-5">
              <li class="hva_bt_sub1-agero">
                <div class="p-b-6">
                  <button type="button" class="btn btn-btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg p-t-10 p-b-10 btn-sports" :class="[isMobile ? '' : 'height-120px', `btn-${themeType}`]" @click="onClickBetButton('player', gameSettings.MGMBaccarat2.playerOdds)">
                    <center>
                      <div class="btn">
                      ...
                      <div class="f-s-12 text-white" :class="{'btn': !isMobile}"><span style="font-size:20pt; font-family:arial;">{{gameSettings.MGMBaccarat2.playerOdds | filterOdds()}}</span></div>
                    </center>
                  </button>
                </div>
                <div v-if="!isMobile" class="p-t-6">
                  <button type="button" class="btn btn-btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg p-t-10 p-b-10 btn-sports" :class="[isMobile ? '' : 'height-120px', `btn-${themeType}`]" @click="onClickBetButton('player-pair', gameSettings.MGMBaccarat2.pairOdds)">
                      <center>
                        <div class="btn">
                        ...
                        <div class="f-s-12 text-white" :class="{'btn': !isMobile}"><span style="font-size:20pt; font-family:arial;">{{gameSettings.MGMBaccarat2.pairOdds | filterOdds()}}</span></div>
                      </center>
              ...
              <li class="hva_bt_sub1-agero p-l-10 p-r-10">
                <button v-if="!isMobile" type="button" class="btn btn-btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg p-t-10 p-b-10 btn-sports" :class="[isMobile ? '' : 'height-180', `btn-${themeType}`]" @click="onClickBetButton('tie', gameSettings.MGMBaccarat2.tieOdds)"> 
                    <center>
                      ...
                      <div class="f-s-15 text-white m-t-20 m-b-10"><span style="font-size:20pt; font-family:arial;">{{gameSettings.MGMBaccarat2.tieOdds | filterOdds()}}</span></div>
                    </center>
                </button>
                <div v-else class="p-b-6">
                  <button type="button" class="btn btn-btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg p-t-10 p-b-10 btn-sports" :class="`btn-${themeType}`" :style="isMobile ? '' : 'height:120px;'" @click="onClickBetButton('tie', gameSettings.MGMBaccarat2.tieOdds)">
                    <center>
                      <div class="btn">
                        <div class="rounded-corner bg-black21 width-70 height-70 f-s-18 p-t-5 position-relative">
                          <strong>
                      ...
                      <div class="f-s-12 text-white" :class="{'btn': !isMobile}"><span style="font-size:20pt; font-family:arial;">{{gameSettings.MGMBaccarat2.tieOdds | filterOdds()}}</span></div>
                    </center>
                  </button>
                </div>
              </li>
              <li class="hva_bt_sub1-agero">
                <div class="p-b-6">
                  <button type="button" class="btn btn-btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg p-t-10 p-b-10 btn-sports" :class="[isMobile ? '' : 'height-120px', `btn-${themeType}`]" @click="onClickBetButton('banker', gameSettings.MGMBaccarat2.bankerOdds)">
                      <center>
                        <div class="btn">
                          <div class="rounded-corner bg-black21 width-70 height-70 f-s-18 p-t-5 position-relative">
                            <strong>
                        ...
                        <div class="f-s-12 text-white" :class="{'btn': !isMobile}"><span style="font-size:20pt; font-family:arial;">{{gameSettings.MGMBaccarat2.bankerOdds | filterOdds()}}</span></div>
                      </center>
                  </button>
                </div>
                <div v-if="!isMobile" class="p-t-6">
                  <button type="button" class="btn btn-btn btn-block btnstyle1 btnstyle1-inverse3 btnstyle1-bg p-t-10 p-b-10 btn-sports" :class="[isMobile ? '' : 'height-120px', `btn-${themeType}`]" @click="onClickBetButton('banker-pair', gameSettings.MGMBaccarat2.pairOdds)">
                    <center>
                      <div class="btn">
                        <div class="rounded-corner bg-black21 width-70 height-70 f-s-18 p-t-15 position-relative">
                          <strong>
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">MGM 바카라2 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "MGMBaccarat2"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      MGMBaccarat2Bet: "getMGMBaccarat2Bet"
    })
  },
  data() {
    return {
      isBetAvailable: true,                                       // 배팅가능상태
      baseUrl: "https://mgm.nutv265.com/baccarat0201.html",    // MGM 바카라2 중계 URL
      remainTime: "00:00",                                        // 현재 회차 남은시간
      currentGameInfo: null,                                      // 현재 회차정보
      gameName: "MGM 바카라2",                                  // 게임명
      gameType: "MGMBaccarat2",                                 // 게임타입
      betLogs: null,                                              // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      calculateTime: null,
  ...
  watch: {
    ...
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.MGMBaccarat2.gameStatus_auto || val.MGMBaccarat2.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.MGMBaccarat2.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'MGM-MGMBaccarat2')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.MGMBaccarat2.levelSetting[this.gameSettings.MGMBaccarat2.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.MGMBaccarat2.gameStatus_auto | this.gameSettings.MGMBaccarat2.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.MGMBaccarat2.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameMGMBaccarat2Round'),
    mainService.on('miniGameMGMBaccarat2Round', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameMGMBaccarat2Time')
    mainService.on('miniGameMGMBaccarat2Time', (state) => {
      this.remainMins = 0
      this.remainSecs = 59
    })
  ...
  methods: {
    ...
    async initframe() {
      if (this.isMobile) {
        this.baseUrl = "https://mgm.nutv265.com/baccarat0201.html"
      } else {
        this.baseUrl = "https://mgm.nutv265.com/m/baccarat0201.html"
      }
