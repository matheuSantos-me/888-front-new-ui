    ...
    <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
      ...
      <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
        ...
        <div class="bg-black-darker">
          <div class="panel-collapse collapse in boscore-playerbox3 minibg" id="CSEP_viewpan">
            <div id="mini-game-frame-container">
              <div id="boscore-game-frame-container-in">
                <iframe id="myframe" :src="baseUrl" width="800" height="600" scrolling="no" frameborder="0" class="mini-game-frame"></iframe>
              </div>
            </div>
            <div class="mini-ifram-lock"></div>
            <el-col class="mini-boscore-bet-panel">
              <el-row>
                ...
                <el-row>
                  <el-row class="mini-bet-row">
                    <el-col :span="isMobile? 24 : 5">
                      <div class="mini-bet-type-name" :class="{'height-83': !isMobile}">
                        좌우
                      </div>
                    </el-col>
                    <el-col :span="isMobile? 24 : 19">
                      <el-col :span="12">
                        <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('left', gameSettings.BoscoreLadder1.lrOdds)">
                          <el-row class="m-t-3">
                            <img class="mini-bet-lad-img" :src="'/image/mini/left.png'">
                          </el-row>
                          <el-row>
                            <span class="f-s-16 mini-bet-base">{{gameSettings.BoscoreLadder1.lrOdds | filterOdds()}}</span>
                          </el-row>
                        </div>
                      </el-col>
                      <el-col :span="12">
                        <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('right', gameSettings.BoscoreLadder1.lrOdds)">
                          <el-row class="m-t-3">
                  ...
                  <el-row class="mini-bet-row">
                    ...
                    <el-col :span="isMobile? 24 : 19">
                      <el-col :span="12">
                        <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('three', gameSettings.BoscoreLadder1.lineOdds)">
                          <el-row class="m-t-3">
                            <img class="mini-bet-lad-img" :src="'/image/mini/line3.png'">
                          </el-row>
                          <el-row>
                            <span class="f-s-16 mini-bet-base">{{gameSettings.BoscoreLadder1.lineOdds | filterOdds()}}</span>
                          </el-row>
                        </div>
                      </el-col>
                      <el-col :span="12">
                        <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('four', gameSettings.BoscoreLadder1.lineOdds)">
                          <el-row class="m-t-3">
                  ...
                  <el-row class="mini-bet-row">
                    ...
                    <el-col :span="isMobile? 24 : 19">
                      <el-col :span="12">
                        <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('odd', gameSettings.BoscoreLadder1.oeOdds)">
                          <el-row class="m-t-3">
                            <img class="mini-bet-lad-img" :src="'/image/mini/odd.png'">
                          </el-row>
                          <el-row>
                            <span class="f-s-16 mini-bet-base">{{gameSettings.BoscoreLadder1.oeOdds | filterOdds()}}</span>
                          </el-row>
                        </div>
                      </el-col>
                      <el-col :span="12">
                        <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('even', gameSettings.BoscoreLadder1.oeOdds)">
                          <el-row class="m-t-3">
                  ...
                  <el-row class="mini-bet-row">
                    ...
                    <el-col :span="isMobile? 24 : 19">
                      <el-row>
                        <el-col :span="12">
                          <div class="mini-bet-button height-107 display-center" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-three-even', gameSettings.BoscoreLadder1.mixedOdds)">
                            <el-row>
                              <el-row>
                              ...
                              <el-row class="f-s-16 mini-bet-base">{{gameSettings.BoscoreLadder1.mixedOdds | filterOdds()}}</el-row>
                            </el-row>
                          </div>
                        </el-col>
                        <el-col :span="12">
                          <div class="mini-bet-button height-107 display-center" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-three-odd', gameSettings.BoscoreLadder1.mixedOdds)">
                            <el-row>
                              <el-row>
                      ...
                      <el-row class="m-t-10">
                        <el-col :span="12">
                          <div class="mini-bet-button height-107 display-center" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-four-odd', gameSettings.BoscoreLadder1.mixedOdds)">
                            <el-row>
                              <el-row>
                                <img class="mini-bet-lad-img-small" :src="'/image/mini/left.png'">
                                <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                        ...
                        <el-col :span="12">
                          <div class="mini-bet-button height-107 display-center" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-four-even', gameSettings.BoscoreLadder1.mixedOdds)">
                            <el-row>
                              <el-row>
                                <img class="mini-bet-lad-img-small" :src="'/image/mini/right.png'">
                                <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
        ...
        <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
          <el-row>
            <el-col :span="24">
              <div class="cursor" :class="`mini-history-tab-${themeType}`">1분 별다리 배팅내역</div>
            </el-col>
          </el-row>
...
const popupRouter = "BoscoreLadder1"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      BoscoreLadder1Bet: "getBoscoreLadder1Bet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://boscore.com/ladder/live1.php",          // 1분 별다리 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "1분 별다리",                                    // 게임명
      gameType: "BoscoreLadder1",                               // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      calculateTime: null,
  ...
  watch: {
    BoscoreLadder1Bet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.BoscoreLadder1.gameStatus_auto || val.BoscoreLadder1.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.BoscoreLadder1.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.BoscoreLadder1.isVisible || !this.gameSettings.Mini.boscore) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-BoscoreLadder1')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.BoscoreLadder1.levelSetting[this.gameSettings.BoscoreLadder1.levelSetting.findIndex(setting => setting.level == userLevel)]
    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BoscoreLadder1.gameStatus_auto | this.gameSettings.BoscoreLadder1.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BoscoreLadder1.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameBoscoreLadder1Round'),
    mainService.on('miniGameBoscoreLadder1Round', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameBoscoreLadder1Time')
    mainService.on('miniGameBoscoreLadder1Time', (state) => {
      this.remainMins = 0
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogBoscoreLadder1')
    mainService.on('miniBetLogBoscoreLadder1', (betLog) => {
