  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('left', gameSettings.BoscoreLadder3.lrOdds)">
                        <el-row class="m-t-3">
                          <img class="mini-bet-lad-img" :src="'/image/mini/left.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.BoscoreLadder3.lrOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('right', gameSettings.BoscoreLadder3.lrOdds)">
                        <el-row class="m-t-3">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('three', gameSettings.BoscoreLadder3.lineOdds)">
                        <el-row class="m-t-3">
                          <img class="mini-bet-lad-img" :src="'/image/mini/line3.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.BoscoreLadder3.lineOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('four', gameSettings.BoscoreLadder3.lineOdds)">
                        <el-row class="m-t-3">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('odd', gameSettings.BoscoreLadder3.oeOdds)">
                        <el-row class="m-t-3">
                          <img class="mini-bet-lad-img" :src="'/image/mini/odd.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.BoscoreLadder3.oeOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-83" :class="[`mini-bet-button-keno-${themeType}`]" @click="onClickBetButton('even', gameSettings.BoscoreLadder3.oeOdds)">
                        <el-row class="m-t-3">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-row>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-three-even', gameSettings.BoscoreLadder3.mixedOdds)">
                          <el-row class="m-t-25">
                          ...
                          <el-row class="f-s-16 mini-bet-base">{{gameSettings.BoscoreLadder3.mixedOdds | filterOdds()}}</el-row>
                        </div>
                      </el-col>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-three-odd', gameSettings.BoscoreLadder3.mixedOdds)">
                          <el-row class="m-t-25">
                    ...
                    <el-row class="m-t-10">
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-four-odd', gameSettings.BoscoreLadder3.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/left.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                      ...
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-four-even', gameSettings.BoscoreLadder3.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/right.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/line4.png'">
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">3분 별다리 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "BoscoreLadder3"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      BoscoreLadder3Bet: "getBoscoreLadder3Bet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://boscore.com/ladder/live3.php",          // 3분 별다리 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "3분 별다리",                                    // 게임명
      gameType: "BoscoreLadder3",                               // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      calculateTime: null,
  ...
  watch: {
    BoscoreLadder3Bet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.BoscoreLadder3.gameStatus_auto || val.BoscoreLadder3.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.BoscoreLadder3.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.BoscoreLadder3.isVisible || !this.gameSettings.Mini.boscore) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-BoscoreLadder3')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.BoscoreLadder3.levelSetting[this.gameSettings.BoscoreLadder3.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BoscoreLadder3.gameStatus_auto | this.gameSettings.BoscoreLadder3.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BoscoreLadder3.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameBoscoreLadder3Round'),
    mainService.on('miniGameBoscoreLadder3Round', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameBoscoreLadder3Time')
    mainService.on('miniGameBoscoreLadder3Time', (state) => {
      this.remainMins = 2
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogBoscoreLadder3')
    mainService.on('miniBetLogBoscoreLadder3', (betLog) => {
