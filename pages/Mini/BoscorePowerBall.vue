  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
      ...
      <div class="bg-black-darker">
        <div class="panel-collapse collapse in boscoreball-playerbox3 minibg " id="CSEP_viewpan">
          <div id="mini-game-frame-container">
            <div id="boscoreball-game-frame-container-in" class="display-center">
              <iframe id="myframe" :src="baseUrl" :width="800" height="700" scrolling="no" frameborder="0" class="mini-game-boscoreball-frame"></iframe>
            </div>
          </div>
          <div class="mini-ifram-lock"></div>
          <el-col class="mini-boscoreball-bet-panel">
            <el-row>
              <el-row class="p-5 height-50">
                ...
                <el-col class="height-full bg-brown1 f-w-700 display-center" :class="isMobile ? 'f-s-12' : 'f-s-15'" style="border-right: 2px solid #996148" :span="8">{{currentGameInfo ? currentGameInfo.roundNumber : 0}}</el-col>
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile? 24 : 5">
                    <div class="mini-bet-type-name" :class="{'height-198': !isMobile}">
                      파워볼
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="6">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-odd', gameSettings.BoscorePowerBall.powerBallOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.powerBallOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-65"><img class="mini-bet-img" :src="'/image/mini/odd.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-even', gameSettings.BoscorePowerBall.powerBallOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.powerBallOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-65"><img class="mini-bet-img" :src="'/image/mini/even.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-under', gameSettings.BoscorePowerBall.powerBallOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.powerBallOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-65"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-over', gameSettings.BoscorePowerBall.powerBallOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.powerBallOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-65"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      </div>
                    </el-col>
                  </el-col>
                </el-row>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="6">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-odd', gameSettings.BoscorePowerBall.normalBallOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.normalBallOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-65"><img class="mini-bet-img" :src="'/image/mini/odd.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-even', gameSettings.BoscorePowerBall.normalBallOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.normalBallOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-65"><img class="mini-bet-img" :src="'/image/mini/even.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-under', gameSettings.BoscorePowerBall.normalBallOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.normalBallOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-65"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-over', gameSettings.BoscorePowerBall.normalBallOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.normalBallOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-65"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      </div>
                    </el-col>
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="8">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-big', gameSettings.BoscorePowerBall.normalBallSize.high)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.normalBallSize.high | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-65">대</el-row>
                      <el-row class="mini-bet-base">198-335</el-row>
                      <img class="float-left mini-bet-img-size m-l-1 m-t-47" :src="'/image/mini/big.png'">
                      </div>
                    </el-col>
                    <el-col :span="8">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-middle', gameSettings.BoscorePowerBall.normalBallSize.normal)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.normalBallSize.normal | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-65">중</el-row>
                      <el-row class="mini-bet-base">153-197</el-row>
                      <img class="float-left mini-bet-img-size m-l-1 m-t-47" :src="'/image/mini/middle.png'">
                      </div>
                    </el-col>
                    <el-col :span="8">
                      <div class="mini-bet-button height-198" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-small', gameSettings.BoscorePowerBall.normalBallSize.low)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.BoscorePowerBall.normalBallSize.low | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-65">소</el-row>
                      <el-row class="mini-bet-base">15-152</el-row>
                      <img class="float-left mini-bet-img-size m-l-1 m-t-47" :src="'/image/mini/small.png'">
                      </div>
                    </el-col>
                  </el-col>
                </el-row>
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">1분 파워볼 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "BoscorePowerBall"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      BoscorePowerBallBet: "getBoscorePowerBallBet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://boscore.com/powerball/view.php?popup=1",  // 1분 파워볼 중계 URL
      remainTime: "00:00",                                        // 현재 회차 남은시간
      currentGameInfo: null,                                      // 현재 회차정보
      gameName: "1분 파워볼",                                      // 게임명
      gameType: "BoscorePowerBall",                                // 게임타입
      betLogs: null,                                              // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      calculateTime: null,
  ...
  watch: {
    BoscorePowerBallBet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.BoscorePowerBall.gameStatus_auto || val.BoscorePowerBall.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.BoscorePowerBall.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.BoscorePowerBall.isVisible || !this.gameSettings.Mini.boscore) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-BoscorePowerBall')
    this.initframe()
    this.$store.commit("SET_LEFTSIDEMENUTYPE", 0)
    this.$store.commit("SET_MINIGAMETYPE", 4)

    // 게임셋팅정보 배팅슬립정보 설정
    let userLevel = this.currentUser ? this.currentUser.level : 2
    let levelSetting = this.gameSettings.BoscorePowerBall.levelSetting[this.gameSettings.BoscorePowerBall.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BoscorePowerBall.gameStatus_auto | this.gameSettings.BoscorePowerBall.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BoscorePowerBall.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameBoscorePowerBallRound'),
    mainService.on('miniGameBoscorePowerBallRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameBoscorePowerBallTime')
    mainService.on('miniGameBoscorePowerBallTime', (state) => {
      this.remainMins = 0
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogBoscorePowerBall')
    mainService.on('miniBetLogBoscorePowerBall', (betLog) => {
  ...
  methods: {
    ...
    initframe() {
      if (this.isMobile) {
        ...
        jQuery('#boscoreball-game-frame-container-in').css('height', aheight);
      } else {
        if (this.screenWidth > 1600) {
          ...
          this.isShowMobile = true
          jQuery('#myframe').css('transform', "scale(1, 1) translateX(0px)");
          
          let s = 600 / 800;
          let aleft = (-1) * (1 - s) * 400 + (this.screenWidth - 614 - 600) / 2;
          let atop = (-1) *(1 - s) * 350;
          let aheight = s * 700;
          jQuery('#myframe').css('left', aleft);
          jQuery('#myframe').css('top', atop);
          jQuery('#myframe').css('transform', "scale(" + s + "," + s + ")");
          jQuery('#boscoreball-game-frame-container-in').css('height', aheight);
        } else if (this.screenWidth > 1080 && this.screenWidth <= 1280) {
          this.isShowMobile = true
          jQuery('#myframe').css('transform', "scale(1, 1) translateX(0px)");
          
          let s = 600 / 800;
          let aleft = (-1) * (1 - s) * 400 + (this.screenWidth - 365 - 600) / 2;
          let atop = (-1) *(1 - s) * 350;
          let aheight = s * 700;
          jQuery('#myframe').css('left', aleft);
          jQuery('#myframe').css('top', atop);
          ...
          let s = 600 / 800;
          let aleft = (-1) * (1 - s) * 400 + (this.screenWidth - 70 - 600) / 2;
          let atop = (-1) *(1 - s) * 350;
          let aheight = s * 700;
          jQuery('#myframe').css('left', aleft);
          jQuery('#myframe').css('top', atop);
        ...
        jQuery('#boscoreball-game-frame-container-in').css('height', 700);
      }
    },
    // 배팅하기
