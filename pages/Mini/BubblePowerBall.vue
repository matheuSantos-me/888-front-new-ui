  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
      ...
      <div class="bg-black-darker">
        <div class="panel-collapse collapse in bubble-playerbox3 minibg " id="CSEP_viewpan">
          <div id="mini-game-frame-container">
            <div id="bubble-game-frame-container-in">
              <iframe id="myframe" :src="baseUrl" width="830" height="660" scrolling="no" frameborder="0" class="mini-game-frame"></iframe>
            </div>
          </div>
          <div class="mini-ifram-lock"></div>
          <el-col class="mini-bubble-bet-panel">
            <el-row>
              <el-row class="p-5 height-50">
                ...
                <el-col class="height-full bg-brown text-brown f-w-700 display-center" :class="isMobile ? 'f-s-12' : 'f-s-14'" style="border-left: 2px solid #996148" :span="4">배팅마감</el-col>
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile? 24 : 5">
                    <div class="mini-bet-type-name" :class="{'height-168': !isMobile}">
                      파워볼
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="6">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-odd', gameSettings.BubblePowerBall.powerOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.powerOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-50"><img class="mini-bet-img" :src="'/image/mini/odd.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-even', gameSettings.BubblePowerBall.powerOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.powerOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-50"><img class="mini-bet-img" :src="'/image/mini/even.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-under', gameSettings.BubblePowerBall.powerOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.powerOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-50"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-over', gameSettings.BubblePowerBall.powerOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.powerOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-50"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      </div>
                    </el-col>
                  </el-col>
                </el-row>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="6">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-odd', gameSettings.BubblePowerBall.normalOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.normalOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-50"><img class="mini-bet-img" :src="'/image/mini/odd.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-even', gameSettings.BubblePowerBall.normalOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.normalOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-50"><img class="mini-bet-img" :src="'/image/mini/even.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-under', gameSettings.BubblePowerBall.normalOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.normalOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-50"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-over', gameSettings.BubblePowerBall.normalOdds)">
                        <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.normalOdds | filterOdds()}}</el-row>
                        <el-row class="m-t-50"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      </div>
                    </el-col>
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="8">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-big', gameSettings.BubblePowerBall.sizeOdds.high)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.sizeOdds.high | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-50">대</el-row>
                      <el-row class="mini-bet-base">81-130</el-row>
                      <img class="float-left mini-bet-img-size m-l-1 m-t-32" :src="'/image/mini/big.png'">
                      </div>
                    </el-col>
                    <el-col :span="8">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-middle', gameSettings.BubblePowerBall.sizeOdds.normal)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.sizeOdds.normal | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-50">중</el-row>
                      <el-row class="mini-bet-base">65-80</el-row>
                      <img class="float-left mini-bet-img-size m-l-1 m-t-32" :src="'/image/mini/middle.png'">
                      </div>
                    </el-col>
                    <el-col :span="8">
                      <div class="mini-bet-button height-168" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-small', gameSettings.BubblePowerBall.sizeOdds.low)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.BubblePowerBall.sizeOdds.low | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-50">소</el-row>
                      <el-row class="mini-bet-base">15-64</el-row>
                      <img class="float-left mini-bet-img-size m-l-1 m-t-32" :src="'/image/mini/small.png'">
                      </div>
                    </el-col>
                  </el-col>
                </el-row>
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">보글 파워볼 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "BubblePowerBall"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      BubblePowerBallBet: "getBubblePowerBallBet"
    })
  },
  data() {
    return {
      isBetAvailable: true,                                     // 배팅가능상태
      baseUrl: "https://bepick.net/live/bubblepower/scrap",     // 보글 파워볼 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "보글 파워볼",                                   // 게임명
      gameType: "BubblePowerBall",                              // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      calculateTime: null,
  ...
  watch: {
    BubblePowerBallBet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.BubblePowerBall.gameStatus_auto || val.BubblePowerBall.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.BubblePowerBall.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.BubblePowerBall.isVisible || !this.gameSettings.Mini.bubble) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-BubblePowerBall')
    this.initframe()
    this.$store.commit("SET_LEFTSIDEMENUTYPE", 0)
    this.$store.commit("SET_MINIGAMETYPE", 3)

    // 게임셋팅정보 배팅슬립정보 설정
    let userLevel = this.currentUser ? this.currentUser.level : 2
    let levelSetting = this.gameSettings.BubblePowerBall.levelSetting[this.gameSettings.BubblePowerBall.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BubblePowerBall.gameStatus_auto | this.gameSettings.BubblePowerBall.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.BubblePowerBall.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameBubblePowerBallRound'),
    mainService.on('miniGameBubblePowerBallRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameBubblePowerBallTime')
    mainService.on('miniGameBubblePowerBallTime', (state) => {
      this.remainMins = 1
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogBubblePowerBall')
    mainService.on('miniBetLogBubblePowerBall', (betLog) => {
