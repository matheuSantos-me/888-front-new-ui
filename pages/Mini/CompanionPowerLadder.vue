  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
        ...
        <div class="panel-collapse collapse in bubble-playerbox3 minibg " id="CSEP_viewpan">
          <div id="mini-game-frame-container">
            <div id="bubble-game-frame-container-in">
              <iframe :src="baseUrl" width="830" height="660" scrolling="no" frameborder="0" id="myframe" class="mini-game-frame"></iframe>
            </div>
          </div>
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-87': !isMobile}">
                      결과
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-87" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('odd', gameSettings.CompanionPowerLadder.OEOdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/odd.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.CompanionPowerLadder.OEOdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-87" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('even', gameSettings.CompanionPowerLadder.OEOdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-87" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left', gameSettings.CompanionPowerLadder.LROdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/left.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.CompanionPowerLadder.LROdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-87" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right', gameSettings.CompanionPowerLadder.LROdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-87" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('three', gameSettings.CompanionPowerLadder.LineOdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/line3.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.CompanionPowerLadder.LineOdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-87" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('four', gameSettings.CompanionPowerLadder.LineOdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 20">
                    <el-row>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-three-even', gameSettings.CompanionPowerLadder.mixedOdds)">
                          <el-row class="m-t-25">
                          ...
                          <el-row class="f-s-16 mini-bet-base">{{gameSettings.CompanionPowerLadder.mixedOdds | filterOdds()}}</el-row>
                        </div>
                      </el-col>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-three-odd', gameSettings.CompanionPowerLadder.mixedOdds)">
                          <el-row class="m-t-25">
                    ...
                    <el-row class="m-t-10">
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-four-odd', gameSettings.CompanionPowerLadder.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/left.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                      ...
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-four-even', gameSettings.CompanionPowerLadder.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/right.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/line4.png'">
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">동행파워사다리 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "CompanionPowerLadder"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      CompanionPowerLadderBet: "getCompanionPowerLadderBet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://bepick.net/live/powerladder/scrap",  // 동행파워사다리 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "동행파워사다리",                                    // 게임명
      gameType: "CompanionPowerLadder",                                  // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      isCheck: true
  ...
  watch: {
    CompanionPowerLadderBet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.CompanionPowerLadder.gameStatus_auto || val.CompanionPowerLadder.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.CompanionPowerLadder.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.CompanionPowerLadder.isVisible || !this.gameSettings.Mini.companion) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-CompanionPowerLadder')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.CompanionPowerLadder.levelSetting[this.gameSettings.CompanionPowerLadder.levelSetting.findIndex(setting => setting.level == userLevel)]
    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.CompanionPowerLadder.gameStatus_auto | this.gameSettings.CompanionPowerLadder.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.CompanionPowerLadder.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameCompanionPowerLadderRound'),
    mainService.on('miniGameCompanionPowerLadderRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameCompanionPowerLadderTime')
    mainService.on('miniGameCompanionPowerLadderTime', (state) => {
      this.remainMins = 4
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogCompanionPowerLadder')
    mainService.on('miniBetLogCompanionPowerLadder', (betLog) => {
