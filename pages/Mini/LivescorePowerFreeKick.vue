  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('first', gameSettings.LivescorePowerFreeKick.numberOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/first.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.LivescorePowerFreeKick.numberOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('second', gameSettings.LivescorePowerFreeKick.numberOdds)">
                        <el-row class="m-t-20">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('left', gameSettings.LivescorePowerFreeKick.lrOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/left.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.LivescorePowerFreeKick.lrOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('right', gameSettings.LivescorePowerFreeKick.lrOdds)">
                        <el-row class="m-t-20">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('goal', gameSettings.LivescorePowerFreeKick.goalOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/bet-goal.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.LivescorePowerFreeKick.goalOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('nogoal', gameSettings.LivescorePowerFreeKick.goalOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/bet-nogoal.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.LivescorePowerFreeKick.goalOdds | filterOdds()}}</span>
                        </el-row>
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">파워프리킥 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "LivescorePowerFreeKick"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      LivescorePowerFreeKickBet: "getLivescorePowerFreeKickBet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://livescore.co.kr/sports/score_board/new_game/game.php?t=powerball_freekick&link",   // 파워프리킥 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "파워프리킥",                                    // 게임명
      gameType: "LivescorePowerFreeKick",                                  // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      calculateTime: null,
  ...
  watch: {
    LivescorePowerFreeKickBet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.LivescorePowerFreeKick.gameStatus_auto || val.LivescorePowerFreeKick.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.LivescorePowerFreeKick.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.LivescorePowerFreeKick.isVisible || !this.gameSettings.Mini.livescore) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-LivescorePowerFreeKick')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.LivescorePowerFreeKick.levelSetting[this.gameSettings.LivescorePowerFreeKick.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.LivescorePowerFreeKick.gameStatus_auto | this.gameSettings.LivescorePowerFreeKick.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.LivescorePowerFreeKick.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameLivescorePowerFreeKickRound'),
    mainService.on('miniGameLivescorePowerFreeKickRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameLivescorePowerFreeKickTime')
    mainService.on('miniGameLivescorePowerFreeKickTime', (state) => {
      this.remainMins = 4
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogLivescorePowerFreeKick')
    mainService.on('miniBetLogLivescorePowerFreeKick', (betLog) => {
  ...
  methods: {
    ...
    getBetNameFromType ( strTeamName ){
      ...
      switch (strTeamName){
        ...
        case 'goal': strLabel += '골 (골/노골 맞추기)'; break;
        case 'nogoal': strLabel += '노골 (골/노골 맞추기)'; break;
      }
      return strLabel;
    },
    // 경기시간계산
