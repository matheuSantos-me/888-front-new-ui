  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('first', gameSettings.LivescoreSpeedHomeRun.numberOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/first.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.LivescoreSpeedHomeRun.numberOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('second', gameSettings.LivescoreSpeedHomeRun.numberOdds)">
                        <el-row class="m-t-20">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('left', gameSettings.LivescoreSpeedHomeRun.lrOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/left.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.LivescoreSpeedHomeRun.lrOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('right', gameSettings.LivescoreSpeedHomeRun.lrOdds)">
                        <el-row class="m-t-20">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('home', gameSettings.LivescoreSpeedHomeRun.hoOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/home.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.LivescoreSpeedHomeRun.hoOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-213" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('out', gameSettings.LivescoreSpeedHomeRun.hoOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/out.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.LivescoreSpeedHomeRun.hoOdds | filterOdds()}}</span>
                        </el-row>
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">스피드홈런 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "LivescoreSpeedHomeRun"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      LivescoreSpeedHomeRunBet: "getLivescoreSpeedHomeRunBet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://livescore.co.kr/sports/score_board/new_game/game.php?t=speedkeno_homerun&link",   // 스피드홈런 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "스피드홈런",                                    // 게임명
      gameType: "LivescoreSpeedHomeRun",                                  // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      calculateTime: null,
  ...
  watch: {
    LivescoreSpeedHomeRunBet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.LivescoreSpeedHomeRun.gameStatus_auto || val.LivescoreSpeedHomeRun.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.LivescoreSpeedHomeRun.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.LivescoreSpeedHomeRun.isVisible || !this.gameSettings.Mini.livescore) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-LivescoreSpeedHomeRun')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.LivescoreSpeedHomeRun.levelSetting[this.gameSettings.LivescoreSpeedHomeRun.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.LivescoreSpeedHomeRun.gameStatus_auto | this.gameSettings.LivescoreSpeedHomeRun.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.LivescoreSpeedHomeRun.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameLivescoreSpeedHomeRunRound'),
    mainService.on('miniGameLivescoreSpeedHomeRunRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameLivescoreSpeedHomeRunTime')
    mainService.on('miniGameLivescoreSpeedHomeRunTime', (state) => {
      this.remainMins = 4
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogLivescoreSpeedHomeRun')
    mainService.on('miniBetLogLivescoreSpeedHomeRun', (betLog) => {
  ...
  methods: {
    ...
    getBetNameFromType ( strTeamName ){
      ...
      switch (strTeamName){
        ...
        case 'home': strLabel += '홈런 (홈런/아웃 맞추기)'; break;
        case 'out': strLabel += '아웃 (홈런/아웃 맞추기)'; break;
      }
      return strLabel;
    },
    // 경기시간계산
