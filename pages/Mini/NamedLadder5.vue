  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('odd', gameSettings.NamedLadder5.OEOdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/odd.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.NamedLadder5.OEOdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('even', gameSettings.NamedLadder5.OEOdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left', gameSettings.NamedLadder5.LROdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/left.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.NamedLadder5.LROdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right', gameSettings.NamedLadder5.LROdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('three', gameSettings.NamedLadder5.LineOdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/line3.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.NamedLadder5.LineOdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('four', gameSettings.NamedLadder5.LineOdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 20">
                    <el-row>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-three-even', gameSettings.NamedLadder5.mixedOdds)">
                          <el-row class="m-t-25">
                          ...
                          <el-row class="f-s-16 mini-bet-base">{{gameSettings.NamedLadder5.mixedOdds | filterOdds()}}</el-row>
                        </div>
                      </el-col>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-three-odd', gameSettings.NamedLadder5.mixedOdds)">
                          <el-row class="m-t-25">
                    ...
                    <el-row class="m-t-10">
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-four-odd', gameSettings.NamedLadder5.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/left.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                      ...
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-four-even', gameSettings.NamedLadder5.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/right.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/line4.png'">
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">네임드 사다리 5분 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "NamedLadder5"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      NamedLadder5Bet: "getNamedLadder5Bet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://named.com/minigame/nball/powerladder5/pc",  // 네임드 사다리 5분 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "네임드 사다리 5분",                                    // 게임명
      gameType: "NamedLadder5",                                  // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      isCheck: true
  ...
  watch: {
    ...
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.NamedLadder5.gameStatus_auto || val.NamedLadder5.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.NamedLadder5.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.NamedLadder5.isVisible || !this.gameSettings.Mini.named) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-NamedLadder5')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.NamedLadder5.levelSetting[this.gameSettings.NamedLadder5.levelSetting.findIndex(setting => setting.level == userLevel)]
    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.NamedLadder5.gameStatus_auto | this.gameSettings.NamedLadder5.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.NamedLadder5.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameNamedLadder5Round'),
    mainService.on('miniGameNamedLadder5Round', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameNamedLadder5Time')
    mainService.on('miniGameNamedLadder5Time', (state) => {
      this.remainMins = 4
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogNamedLadder5')
    mainService.on('miniBetLogNamedLadder5', (betLog) => {
