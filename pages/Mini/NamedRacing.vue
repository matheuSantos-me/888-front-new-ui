  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="6">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('snail1', gameSettings.NamedRacing.firstSnailOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/first.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.NamedRacing.firstSnailOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('snail2', gameSettings.NamedRacing.firstSnailOdds)">
                        <el-row class="m-t-20">
                    ...
                    <el-col :span="6">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('snail3', gameSettings.NamedRacing.firstSnailOdds)">
                        <el-row class="m-t-20">
                    ...
                    <el-col :span="6">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('snail4', gameSettings.NamedRacing.firstSnailOdds)">
                        <el-row class="m-t-20">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('odd', gameSettings.NamedRacing.oeOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/odd.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.NamedRacing.oeOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col  :span="12">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('even', gameSettings.NamedRacing.oeOdds)">
                        <el-row class="m-t-20">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('under', gameSettings.NamedRacing.uoOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/under.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.NamedRacing.uoOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col  :span="12">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('over', gameSettings.NamedRacing.uoOdds)">
                        <el-row class="m-t-20">
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">달팽이레이싱 배팅내역</div>
          </el-col>
        </el-row>
            ...
            <el-row v-for="(betLog, index) in betLogs" :key="index">
              <el-row class="table-mbetlog-tr" :class="{'on': (layoutType == 'layout3' || layoutType == 'layout5' || layoutType == 'layout6') && index % 2 == 1}">
                ...
                <div class="display-center table-mbetlog-td table-mbetlog-flex-field">
                  {{betLog.betInfo}} - {{betLog.roundNumber}} 회차
                </div>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      NamedRacingBet: "getNamedRacingBet",
  ...
  data() {
    return {
      ...
      baseUrl: "http://named.com/games/snailracing/view.php",   // 달팽이레이싱 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "달팽이레이싱",                                  // 게임명
      gameType: "NamedRacing",                                  // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      calculateTime: null,
  ...
  watch: {
    ...
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.NamedRacing.gameStatus_auto || val.NamedRacing.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.NamedRacing.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.NamedRacing.isVisible || !this.gameSettings.Mini.named) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-NamedRacing')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.NamedRacing.levelSetting[this.gameSettings.NamedRacing.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.NamedRacing.gameStatus_auto | this.gameSettings.NamedRacing.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.NamedRacing.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameNamedRacingRound'),
    mainService.on('miniGameNamedRacingRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameNamedRacingTime')
    mainService.on('miniGameNamedRacingTime', (state) => {
      this.remainMins = 2
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogNamedRacing')
    mainService.on('miniBetLogNamedRacing', (betLog) => {
