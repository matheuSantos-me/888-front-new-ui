  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
          ...
          <el-col class="mini-bet-panel">
            <el-row>
              <el-row class="p-5 height-50">
                ...
                <el-col class="height-full bg-brown1 f-w-700 display-center" :class="isMobile ? 'f-s-12' : 'f-s-15'" style="border-right: 2px solid #996148" :span="8">{{currentGameInfo ? currentGameInfo.round : 0}}회차</el-col>
              ...
              <el-row v-if="gameSettings.NamedRedPowerBall.canBetMix" style="border-top: 5px solid #f4e1c0;">
                <el-col :span="12">
              ...
              <el-row v-if="betType === 0">
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}">
                      {{gameSettings.NamedRedPowerBall.canBetMix ? '파워볼' : '파워볼 홀짝'}}
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-odd', gameSettings.NamedRedPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/odd.png'"></el-row>
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-even', gameSettings.NamedRedPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/even.png'"></el-row>
                    </div>
                  </el-col>
                  <el-col v-if="gameSettings.NamedRedPowerBall.canBetNumber" :span="getSpan()">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-under', gameSettings.NamedRedPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                  </el-col>
                  <el-col v-if="gameSettings.NamedRedPowerBall.canBetNumber" :span="getSpan()">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-over', gameSettings.NamedRedPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                  </el-col>
                </el-row>
                <el-row v-if="!gameSettings.NamedRedPowerBall.canBetNumber" class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}">
                      {{gameSettings.NamedRedPowerBall.canBetNumber ? '파워볼' : '파워볼 언더오버'}}
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-under', gameSettings.NamedRedPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-over', gameSettings.NamedRedPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                ...
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}">
                      {{gameSettings.NamedRedPowerBall.canBetNumber ? '일반볼' : '일반볼 홀짝'}}
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-odd', gameSettings.NamedRedPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/odd.png'"></el-row>
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-even', gameSettings.NamedRedPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/even.png'"></el-row>
                    </div>
                  </el-col>
                  <el-col v-if="gameSettings.NamedRedPowerBall.canBetNumber" :span="getSpan()">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-under', gameSettings.NamedRedPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                  ...
                  <el-col v-if="gameSettings.NamedRedPowerBall.canBetNumber" :span="getSpan()">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-over', gameSettings.NamedRedPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">72.5</el-row>
                    </div>
                ...
                <el-row v-if="!gameSettings.NamedRedPowerBall.canBetNumber" class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}">
                      {{gameSettings.NamedRedPowerBall.canBetNumber ? '일반볼' : '일반볼 언더오버'}}
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-under', gameSettings.NamedRedPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">72.5</el-row>
                    </div>
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-over', gameSettings.NamedRedPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row :class="gameSettings.NamedRedPowerBall.canBetNumber? 'm-t-12': ''"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">72.5</el-row>
                    </div>
                ...
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name word-keep" :class="{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}">
                      일반볼 구간별
                    </div>
                  </el-col>
                  <el-col :class="isMobile ? 'width-33pro' : 'width-27pro'">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-big', gameSettings.NamedRedPowerBall.normalBallSize.high)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallSize.high | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-5">대</el-row>
                      <el-row class="mini-bet-base">81-130</el-row>
                      <img class="float-left mini-bet-img-size m-l-1" :class="{'m-t-m-14': !gameSettings.NamedRedPowerBall.canBetNumber}" :src="'/image/mini/big.png'">
                    </div>
                  </el-col>
                  <el-col :class="isMobile ? 'width-33pro' : 'width-27pro'">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-middle', gameSettings.NamedRedPowerBall.normalBallSize.normal)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallSize.normal | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-5">중</el-row>
                      <el-row class="mini-bet-base">65-80</el-row>
                      <img class="float-left mini-bet-img-size m-l-1" :class="{'m-t-m-14': !gameSettings.NamedRedPowerBall.canBetNumber}" :src="'/image/mini/middle.png'">
                    </div>
                  </el-col>
                  <el-col :class="isMobile ? 'width-33pro' : 'width-27pro'">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.NamedRedPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-small', gameSettings.NamedRedPowerBall.normalBallSize.low)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallSize.low | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-5">소</el-row>
                      <el-row class="mini-bet-base">15-64</el-row>
                      <img class="float-left mini-bet-img-size m-l-1" :class="{'m-t-m-14': !gameSettings.NamedRedPowerBall.canBetNumber}" :src="'/image/mini/small.png'">
                    </div>
                  </el-col>
                </el-row>
                <el-row v-if="gameSettings.NamedRedPowerBall.canBetNumber" class="mini-bet-row">
                  ...
                  <el-col :span="isMobile ? 24 : 20">
                    <el-row>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-0', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/0.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-1', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/1.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-2', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/2.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-3', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/3.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-4', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
                    ...
                    <el-row class="m-t-10">
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-5', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/5.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-6', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/6.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-7', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/7.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-8', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/8.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-9', gameSettings.NamedRedPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBallNumber | filterOdds()}}</el-row>
              ...
              <el-row v-else>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-odd-over', gameSettings.NamedRedPowerBall.powerBall_OO_EU)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBall_OO_EU | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-over.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+오버</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-odd-under', gameSettings.NamedRedPowerBall.powerBall_OU_EO)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBall_OU_EO | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-under.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+언더</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-even-over', gameSettings.NamedRedPowerBall.powerBall_OU_EO)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBall_OU_EO | filterOdds()}}</el-row>
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-even-under', gameSettings.NamedRedPowerBall.powerBall_OO_EU)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.powerBall_OO_EU | filterOdds()}}</el-row>
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-over', gameSettings.NamedRedPowerBall.normalBall_OO_EU)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBall_OO_EU | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-over.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+오버</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-under', gameSettings.NamedRedPowerBall.normalBall_OU_EO)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBall_OU_EO | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-under.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+언더</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-over', gameSettings.NamedRedPowerBall.normalBall_OU_EO)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBall_OU_EO | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/even-over.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">짝+오버</el-row>
                    </div>
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-under', gameSettings.NamedRedPowerBall.normalBall_OO_EU)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBall_OO_EU | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/even-under.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">짝+언더</el-row>
                    </div>
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('odd-odd', gameSettings.NamedRedPowerBall.mixBall)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.mixBall | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-odd.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+홀</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('odd-even', gameSettings.NamedRedPowerBall.mixBall)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.mixBall | filterOdds()}}</el-row>
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('even-odd', gameSettings.NamedRedPowerBall.mixBall)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.mixBall | filterOdds()}}</el-row>
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('even-even', gameSettings.NamedRedPowerBall.mixBall)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.mixBall | filterOdds()}}</el-row>
                  ...
                  <el-col :span="isMobile ? 24 : 20">
                    <el-row>
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-small', gameSettings.NamedRedPowerBall.normalBallMix.small)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallMix.small | filterOdds()}}</el-row>
                          <el-row class="m-t-5"><img :src="'/image/mini/odd-small.png'"></el-row>
                          <el-row class="f-s-14 f-w-700">홀+소</el-row>
                        </div>
                      </el-col>
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-middle', gameSettings.NamedRedPowerBall.normalBallMix.middle)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallMix.middle | filterOdds()}}</el-row>
                          <el-row class="m-t-5"><img :src="'/image/mini/odd-middle.png'"></el-row>
                          <el-row class="f-s-14 f-w-700">홀+중</el-row>
                        </div>
                      </el-col>
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-big', gameSettings.NamedRedPowerBall.normalBallMix.big)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallMix.big | filterOdds()}}</el-row>
                    ...
                    <el-row class="m-t-10">
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-small', gameSettings.NamedRedPowerBall.normalBallMix.small)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallMix.small | filterOdds()}}</el-row>
                      ...
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-middle', gameSettings.NamedRedPowerBall.normalBallMix.middle)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallMix.middle | filterOdds()}}</el-row>
                      ...
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-big', gameSettings.NamedRedPowerBall.normalBallMix.big)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.NamedRedPowerBall.normalBallMix.big | filterOdds()}}</el-row>
      ...
      <el-row v-show="currentUser" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`" @click="onClickHistoryTab(0)">네임드 레드파워볼 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "NamedRedPowerBall"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      NamedRedPowerBallBet: "getNamedRedPowerBallBet",
  ...
  watch: {
    NamedRedPowerBallBet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.NamedRedPowerBall.gameStatus_auto || val.NamedRedPowerBall.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.NamedRedPowerBall.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.NamedRedPowerBall.isVisible || !this.gameSettings.Mini.named) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-NamedRedPowerBall')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.NamedRedPowerBall.levelSetting[this.gameSettings.NamedRedPowerBall.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.NamedRedPowerBall.gameStatus_auto | this.gameSettings.NamedRedPowerBall.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.NamedRedPowerBall.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameNamedRedPowerBallRound'),
    mainService.on('miniGameNamedRedPowerBallRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameNamedRedPowerBallTime')
    mainService.on('miniGameNamedRedPowerBallTime', (state) => {
      this.remainMins = 4
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogNamedRedPowerBall')
    mainService.on('miniBetLogNamedRedPowerBall', (betLog) => {
  ...
  methods: {
    ...
    onClickBetButton(betType, odds) {
      ...
      let data = {
        ...
        leagueName: "네임드 레드파워볼",
        betTypeName: "네임드 레드파워볼-" + this.currentGameInfo.round + " (" + this.currentGameInfo.times + ") 회차",
    ...
    // span 얻기
    getSpan() {
      if (this.gameSettings.NamedRedPowerBall.canBetNumber) {
