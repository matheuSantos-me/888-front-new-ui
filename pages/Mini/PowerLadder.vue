  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('odd', gameSettings.NtryPLadder.OEOdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/odd.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.NtryPLadder.OEOdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('even', gameSettings.NtryPLadder.OEOdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left', gameSettings.NtryPLadder.LROdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/left.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.NtryPLadder.LROdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right', gameSettings.NtryPLadder.LROdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('three', gameSettings.NtryPLadder.LineOdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/line3.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.NtryPLadder.LineOdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('four', gameSettings.NtryPLadder.LineOdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 20">
                    <el-row>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-three-even', gameSettings.NtryPLadder.mixedOdds)">
                          <el-row class="m-t-25">
                          ...
                          <el-row class="f-s-16 mini-bet-base">{{gameSettings.NtryPLadder.mixedOdds | filterOdds()}}</el-row>
                        </div>
                      </el-col>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-three-odd', gameSettings.NtryPLadder.mixedOdds)">
                          <el-row class="m-t-25">
                    ...
                    <el-row class="m-t-10">
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-four-odd', gameSettings.NtryPLadder.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/left.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                      ...
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-four-even', gameSettings.NtryPLadder.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/right.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/line4.png'">
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">파워사다리 배팅내역</div>
          </el-col>
        </el-row>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      ntryPLadderBet: "getNtryPLadderBet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://ntry.com/scores/power_ladder/live.php",  // 파워사다리 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "파워사다리",                                    // 게임명
      gameType: "NtryPLadder",                                  // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      isCheck: true
  ...
  watch: {
    ...
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.NtryPLadder.gameStatus_auto || val.NtryPLadder.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.NtryPLadder.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.NtryPLadder.isVisible || !this.gameSettings.Mini.ntry) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-PowerLadder')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.NtryPLadder.levelSetting[this.gameSettings.NtryPLadder.levelSetting.findIndex(setting => setting.level == userLevel)]
    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.NtryPLadder.gameStatus_auto | this.gameSettings.NtryPLadder.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.NtryPLadder.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameNtryPLadderRound'),
    mainService.on('miniGameNtryPLadderRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameNtryPLadderTime')
    mainService.on('miniGameNtryPLadderTime', (state) => {
      this.remainMins = 4
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogNtryPLadder')
    mainService.on('miniBetLogNtryPLadder', (betLog) => {
