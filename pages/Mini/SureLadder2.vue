  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
      ...
      <div class="bg-black-darker">
        <div class="panel-collapse collapse in playerbox3 minibg " id="CSEP_viewpan">
          <div id="mini-game-frame-container">
            <div id="surel-game-frame-container-in">
              <div class="overflow:hidden;width:678px;height:661px;">
                <div style="width:1740px;height:1645px;overflow:hidden;background:rgb(41,41,41) none repeat scroll 0% 0%;transform:scale(0.402);transform-origin:0px 0px 0px;" id="sure-frame">
                  <iframe src="http://www.sureladder.com/?id=two" scrolling="no" width="1742" height="1645" frameborder="0"></iframe>
                </div>
              </div>
            </div>
            <div style="position: absolute; left: 0; top: 0; width: 100%; display: block;" :style="isMobile ? 'height: 15%;' : 'height: 40%;'"></div>
          </div>
          <el-col class="mini-surel-bet-panel">
            <el-row>
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('odd', gameSettings.SureLadder2.OEOdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/odd.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.SureLadder2.OEOdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('even', gameSettings.SureLadder2.OEOdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left', gameSettings.SureLadder2.LROdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/left.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.SureLadder2.LROdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right', gameSettings.SureLadder2.LROdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('three', gameSettings.SureLadder2.LineOdds)">
                      <el-row class="m-t-23">
                        <img class="mini-bet-lad-img" :src="'/image/mini/line3.png'">
                        <span class="f-s-16 mini-bet-base">{{gameSettings.SureLadder2.LineOdds | filterOdds()}}</span>
                      </el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 12 : 10">
                    <div class="mini-bet-button height-97" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('four', gameSettings.SureLadder2.LineOdds)">
                      <el-row class="m-t-23">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 20">
                    <el-row>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-three-even', gameSettings.SureLadder2.mixedOdds)">
                          <el-row class="m-t-25">
                          ...
                          <el-row class="f-s-16 mini-bet-base">{{gameSettings.SureLadder2.mixedOdds | filterOdds()}}</el-row>
                        </div>
                      </el-col>
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-three-odd', gameSettings.SureLadder2.mixedOdds)">
                          <el-row class="m-t-25">
                    ...
                    <el-row class="m-t-10">
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('left-four-odd', gameSettings.SureLadder2.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/left.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                      ...
                      <el-col :span="12">
                        <div class="mini-bet-button height-107" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('right-four-even', gameSettings.SureLadder2.mixedOdds)">
                          <el-row class="m-t-25">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/right.png'">
                            <img class="mini-bet-lad-img-plus" :src="'/image/mini/Plus.png'">
                            <img class="mini-bet-lad-img-small" :src="'/image/mini/line4.png'">
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">슈어사다리 2분 배팅내역</div>
          </el-col>
        </el-row>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      SureLadder2Bet: "getSureLadder2Bet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://ntry.com/scores/power_ladder/live.php",  // 슈어사다리 2분 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "슈어사다리 2분",                                    // 게임명
      gameType: "SureLadder2",                                  // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      isCheck: true
  ...
  watch: {
    ...
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.SureLadder2.gameStatus_auto || val.SureLadder2.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.SureLadder2.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.SureLadder2.isVisible || !this.gameSettings.Mini.sureman) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-SureLadder2')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.SureLadder2.levelSetting[this.gameSettings.SureLadder2.levelSetting.findIndex(setting => setting.level == userLevel)]
    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.SureLadder2.gameStatus_auto | this.gameSettings.SureLadder2.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.SureLadder2.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameSureLadder2Round'),
    mainService.on('miniGameSureLadder2Round', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameSureLadder2Time')
    mainService.on('miniGameSureLadder2Time', (state) => {
      this.remainMins = 1
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogSureLadder2')
    mainService.on('miniBetLogSureLadder2', (betLog) => {
  ...
  methods: {
    ...
    initframe() {
      if (this.isMobile) {
        let s = window.innerWidth / 1300;
        let aheight = s * 1645;
        jQuery('#surel-game-frame-container-in').css('height', aheight);
        jQuery('#sure-frame').css('transform', "scale(" + s + "," + s + ") translateX(-395px)");
      } else {
        jQuery('#sure-frame').css('transform', "scale(0.402, 0.402) translateX(0)");
        jQuery('#surel-game-frame-container-in').css('height', 641);
      }
    },
    // 배팅하기
