  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
      ...
      <div class="bg-black-darker">
        <div class="panel-collapse playerbox3 minibg " id="CSEP_viewpan">
          <div id="sureframe" ref="sureframe">
            <div id="surer-game-frame-container-in" style="position: relative;">
              <iframe src="http://www.sureracer.com/?id=two" scrolling="no" width="900" height="880" frameborder="0" id="myframe" class="sure-race-frame"></iframe>
            </div>
            <div style="position: absolute; left: 0; top: 0; width: 100%; display: block;" :style="isMobile ? 'height: 15%;' : 'height: 40%;'"></div>
          </div>
          <el-col class="mini-surer-bet-panel">
            <el-row>
              ...
              <el-row>
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile? 24 : 5">
                    <div class="mini-bet-type-name" :class="{'height-179': !isMobile}">
                      1등 달팽이
                    </div>
                  </el-col>
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="6">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('snail1', gameSettings.SureRacing2.firstSnailOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/first.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.SureRacing2.firstSnailOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('snail2', gameSettings.SureRacing2.firstSnailOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/second.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.SureRacing2.firstSnailOdds | filterOdds()}}</span>
                        </el-row>
                    ...
                    <el-col :span="6">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('snail3', gameSettings.SureRacing2.firstSnailOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/third.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.SureRacing2.firstSnailOdds | filterOdds()}}</span>
                        </el-row>
                    ...
                    <el-col :span="6">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('snail4', gameSettings.SureRacing2.firstSnailOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/forth.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.SureRacing2.firstSnailOdds | filterOdds()}}</span>
                        </el-row>
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('odd', gameSettings.SureRacing2.oeOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/odd.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.SureRacing2.oeOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col  :span="12">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('even', gameSettings.SureRacing2.oeOdds)">
                        <el-row class="m-t-20">
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile? 24 : 19">
                    <el-col :span="12">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('under', gameSettings.SureRacing2.uoOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/under.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.SureRacing2.uoOdds | filterOdds()}}</span>
                        </el-row>
                      </div>
                    </el-col>
                    <el-col  :span="12">
                      <div class="mini-bet-button-keno height-179" :class="`mini-bet-button-keno-${themeType}`" @click="onClickBetButton('over', gameSettings.SureRacing2.uoOdds)">
                        <el-row class="m-t-20">
                          <img class="mini-bet-lad-img" :src="'/image/mini/over.png'">
                        </el-row>
                        <el-row>
                          <span class="f-s-16 mini-bet-base">{{gameSettings.SureRacing2.uoOdds | filterOdds()}}</span>
                        </el-row>
      ...
      <el-row v-if="betLogs" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`">슈어레이싱 2분 배팅내역</div>
          </el-col>
        </el-row>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      SureRacing2Bet: "getSureRacing2Bet",
  ...
  data() {
    return {
      ...
      baseUrl: "https://www.sureladder.com/?id=one",            // 슈어레이싱 2분 중계 URL
      remainTime: "00:00",                                      // 현재 회차 남은시간
      currentGameInfo: null,                                    // 현재 회차정보
      gameName: "슈어 레이싱 2분",                                    // 게임명
      gameType: "SureRacing2",                                  // 게임타입
      betLogs: null,                                            // 배팅내역
      remainMins: 0,
      remainSecs: 0,
      isCheck: true
  ...
  watch: {
    ...
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.SureRacing2.gameStatus_auto || val.SureRacing2.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.SureRacing2.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.SureRacing2.isVisible || !this.gameSettings.Mini.sureman) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-SureRacing2')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.SureRacing2.levelSetting[this.gameSettings.SureRacing2.levelSetting.findIndex(setting => setting.level == userLevel)]
    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.SureRacing2.gameStatus_auto | this.gameSettings.SureRacing2.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.SureRacing2.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameSureRacing2Round'),
    mainService.on('miniGameSureRacing2Round', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameSureRacing2Time')
    mainService.on('miniGameSureRacing2Time', (state) => {
      this.remainMins = 1
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogSureRacing2')
    mainService.on('miniBetLogSureRacing2', (betLog) => {
  ...
  methods: {
    ...
    initframe() {
      if (this.isMobile) {
        let s = window.innerWidth / 900;
        let aheight = s * 880;
        let x = (-1) * (1 - s) * 450;
        let y = (-1) * (1 - s) * 440;
        jQuery('#surer-game-frame-container-in').css('height', aheight);
        jQuery('#myframe').css('transform',`scale(${s}, ${s})`);
        jQuery('#myframe').css('left', x);
        jQuery('#myframe').css('top', y);
      } else {
        let x = (-1) * (1 - 0.731) * 450;
        let y = (-1) * (1 - 0.731) * 440;
        jQuery('#myframe').css('transform',`scale(${0.731}, ${0.731})`);
        jQuery('#myframe').css('left', x);
        jQuery('#myframe').css('top', y);
        jQuery('#surer-game-frame-container-in').css('height', 641);
      }
    },
    // 배팅하기
    ...
    getBetNameFromType ( strTeamName ){
      var strLabel = '';
      switch (strTeamName){
        case 'snail1': strLabel += '1번 (1등 달팽이 맞추기)'; break;
        case 'snail2': strLabel += '2번 (1등 달팽이 맞추기)'; break;
        case 'snail3': strLabel += '3번 (1등 달팽이 맞추기)'; break;
        case 'snail4': strLabel += '4번 (1등 달팽이 맞추기)'; break;
