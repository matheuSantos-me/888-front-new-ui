  ...
  <div class="animated fadeInDown panel panel-inverse" :class="`panel-page-${themeType}`">
    ...
    <div class="panel-body position-relative height-full" :class="`mini-page-bg-${themeType}`" data-height="100%">
      ...
      <div class="bg-black-darker">
        <div class="panel-collapse collapse in playerbox3 minibg">
          <div id="mini-game-frame-container">
            <div id="mini-game-frame-container-in" class="display-center">
              <iframe :src="baseUrl" :width="isMobile ? 360 : 830" :height="isMobile ? 250 : 415" scrolling="no" frameborder="0" id="myframe" :class="{'position-absolute': isMobile}"></iframe>
            </div>
          </div>
          <el-col class="mini-bet-panel">
            <el-row>
              ...
              <el-row v-if="gameSettings.TokenPowerBall.canBetMix" style="border-top: 5px solid #f4e1c0;">
                <el-col :span="12">
              ...
              <el-row v-if="betType === 0">
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-79': !gameSettings.TokenPowerBall.canBetNumber}">
                      {{gameSettings.TokenPowerBall.canBetMix ? '파워볼' : '파워볼 홀짝'}}
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-odd', gameSettings.TokenPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/odd.png'"></el-row>
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-even', gameSettings.TokenPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/even.png'"></el-row>
                    </div>
                  </el-col>
                  <el-col v-if="gameSettings.TokenPowerBall.canBetNumber" :span="getSpan()">
                    <div class="mini-bet-button" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-under', gameSettings.TokenPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                  </el-col>
                  <el-col v-if="gameSettings.TokenPowerBall.canBetNumber" :span="getSpan()">
                    <div class="mini-bet-button" :class="[`mini-bet-button-${themeType}`]" @click="onClickBetButton('power-over', gameSettings.TokenPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                  </el-col>
                </el-row>
                <el-row v-if="!gameSettings.TokenPowerBall.canBetNumber" class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-79': !gameSettings.TokenPowerBall.canBetNumber}">
                      {{gameSettings.TokenPowerBall.canBetNumber ? '파워볼' : '파워볼 언더오버'}}
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-under', gameSettings.TokenPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-over', gameSettings.TokenPowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                ...
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-79': !gameSettings.TokenPowerBall.canBetNumber}">
                      {{gameSettings.TokenPowerBall.canBetNumber ? '일반볼' : '일반볼 홀짝'}}
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-odd', gameSettings.TokenPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/odd.png'"></el-row>
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-even', gameSettings.TokenPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/even.png'"></el-row>
                    </div>
                  </el-col>
                  <el-col v-if="gameSettings.TokenPowerBall.canBetNumber" :span="getSpan()">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-under', gameSettings.TokenPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                  ...
                  <el-col v-if="gameSettings.TokenPowerBall.canBetNumber" :span="getSpan()">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-over', gameSettings.TokenPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">72.5</el-row>
                    </div>
                ...
                <el-row v-if="!gameSettings.TokenPowerBall.canBetNumber" class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-79': !gameSettings.TokenPowerBall.canBetNumber}">
                      {{gameSettings.TokenPowerBall.canBetNumber ? '일반볼' : '일반볼 언더오버'}}
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-under', gameSettings.TokenPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">72.5</el-row>
                    </div>
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-over', gameSettings.TokenPowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">72.5</el-row>
                    </div>
                ...
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name word-keep" :class="{'height-79': !gameSettings.TokenPowerBall.canBetNumber}">
                      일반볼 구간별
                    </div>
                  </el-col>
                  <el-col :class="isMobile ? 'width-33pro' : 'width-27pro'">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-big', gameSettings.TokenPowerBall.normalBallSize.high)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallSize.high | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-5">대</el-row>
                      <el-row class="mini-bet-base">81-130</el-row>
                      <img class="float-left mini-bet-img-size m-l-1" :class="{'m-t-m-14': !gameSettings.TokenPowerBall.canBetNumber}" :src="'/image/mini/big.png'">
                    </div>
                  </el-col>
                  <el-col :class="isMobile ? 'width-33pro' : 'width-27pro'">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-middle', gameSettings.TokenPowerBall.normalBallSize.normal)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallSize.normal | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-5">중</el-row>
                      <el-row class="mini-bet-base">65-80</el-row>
                      <img class="float-left mini-bet-img-size m-l-1" :class="{'m-t-m-14': !gameSettings.TokenPowerBall.canBetNumber}" :src="'/image/mini/middle.png'">
                    </div>
                  </el-col>
                  <el-col :class="isMobile ? 'width-33pro' : 'width-27pro'">
                    <div class="mini-bet-button" :class="[{'height-79': !gameSettings.TokenPowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-small', gameSettings.TokenPowerBall.normalBallSize.low)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallSize.low | filterOdds()}}</el-row>
                      <el-row class="f-s-23 f-w-700 m-t-5">소</el-row>
                      <el-row class="mini-bet-base">15-64</el-row>
                      <img class="float-left mini-bet-img-size m-l-1" :class="{'m-t-m-14': !gameSettings.TokenPowerBall.canBetNumber}" :src="'/image/mini/small.png'">
                    </div>
                  </el-col>
                </el-row>
                <el-row v-if="gameSettings.TokenPowerBall.canBetNumber" class="mini-bet-row">
                  ...
                  <el-col :span="isMobile ? 24 : 20">
                    <el-row>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-0', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/0.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-1', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/1.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-2', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/2.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-3', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/3.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-4', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
                    ...
                    <el-row class="m-t-10">
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-5', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/5.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-6', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/6.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-7', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/7.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-8', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
                          <el-row class="m-t-8"><img class="mini-bet-num-img" :src="'/image/mini/8.png'"></el-row>
                        </div>
                      </el-col>
                      <el-col class="width-20pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-num-9', gameSettings.TokenPowerBall.powerBallNumber)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBallNumber | filterOdds()}}</el-row>
              ...
              <el-row v-else>
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-odd-over', gameSettings.TokenPowerBall.powerBall_OO_EU)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBall_OO_EU | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-over.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+오버</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-odd-under', gameSettings.TokenPowerBall.powerBall_OU_EO)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBall_OU_EO | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-under.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+언더</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-even-over', gameSettings.TokenPowerBall.powerBall_OU_EO)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBall_OU_EO | filterOdds()}}</el-row>
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('power-even-under', gameSettings.TokenPowerBall.powerBall_OO_EU)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.powerBall_OO_EU | filterOdds()}}</el-row>
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-over', gameSettings.TokenPowerBall.normalBall_OO_EU)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBall_OO_EU | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-over.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+오버</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-under', gameSettings.TokenPowerBall.normalBall_OU_EO)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBall_OU_EO | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-under.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+언더</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-over', gameSettings.TokenPowerBall.normalBall_OU_EO)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBall_OU_EO | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/even-over.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">짝+오버</el-row>
                    </div>
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-under', gameSettings.TokenPowerBall.normalBall_OO_EU)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBall_OO_EU | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/even-under.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">짝+언더</el-row>
                    </div>
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('odd-odd', gameSettings.TokenPowerBall.mixBall)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.mixBall | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img :src="'/image/mini/odd-odd.png'"></el-row>
                      <el-row class="f-s-18 f-w-700">홀+홀</el-row>
                    </div>
                  </el-col>
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('odd-even', gameSettings.TokenPowerBall.mixBall)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.mixBall | filterOdds()}}</el-row>
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('even-odd', gameSettings.TokenPowerBall.mixBall)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.mixBall | filterOdds()}}</el-row>
                  ...
                  <el-col :span="isMobile ? 6 : 5">
                    <div class="mini-bet-button" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('even-even', gameSettings.TokenPowerBall.mixBall)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.mixBall | filterOdds()}}</el-row>
                  ...
                  <el-col :span="isMobile ? 24 : 20">
                    <el-row>
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-small', gameSettings.TokenPowerBall.normalBallMix.small)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallMix.small | filterOdds()}}</el-row>
                          <el-row class="m-t-5"><img :src="'/image/mini/odd-small.png'"></el-row>
                          <el-row class="f-s-14 f-w-700">홀+소</el-row>
                        </div>
                      </el-col>
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-middle', gameSettings.TokenPowerBall.normalBallMix.middle)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallMix.middle | filterOdds()}}</el-row>
                          <el-row class="m-t-5"><img :src="'/image/mini/odd-middle.png'"></el-row>
                          <el-row class="f-s-14 f-w-700">홀+중</el-row>
                        </div>
                      </el-col>
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-odd-big', gameSettings.TokenPowerBall.normalBallMix.big)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallMix.big | filterOdds()}}</el-row>
                    ...
                    <el-row class="m-t-10">
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-small', gameSettings.TokenPowerBall.normalBallMix.small)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallMix.small | filterOdds()}}</el-row>
                      ...
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-middle', gameSettings.TokenPowerBall.normalBallMix.middle)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallMix.middle | filterOdds()}}</el-row>
                      ...
                      <el-col class="width-33pro">
                        <div class="mini-bet-button height-65" :class="`mini-bet-button-${themeType}`" @click="onClickBetButton('normal-even-big', gameSettings.TokenPowerBall.normalBallMix.big)">
                          <el-row class="mini-bet-odds-value">{{gameSettings.TokenPowerBall.normalBallMix.big | filterOdds()}}</el-row>
      ...
      <el-row v-show="currentUser" class="m-t-13 display-inlineblock width-full">
        <el-row>
          <el-col :span="24">
            <div class="cursor" :class="`mini-history-tab-${themeType}`" @click="onClickHistoryTab(0)">토큰파워볼 배팅내역</div>
          </el-col>
        </el-row>
...
const popupRouter = "TokenPowerBall"
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      tokenPowerBallBet: "getTokenPowerBallBet",
  ...
  watch: {
    tokenPowerBallBet(val) {
      this.isBetAvailable = !Boolean(val)
    },
    gameSettings(val) {
      this.isBetAvailable = !Boolean(val.gameStatus_socket || val.TokenPowerBall.gameStatus_auto || val.TokenPowerBall.gameStatus_manual)
      this.isCheck = !Boolean(val.gameStatus_socket || val.TokenPowerBall.gameStatus_manual)
    },
    isBetAvailable(val){
  ...
  created() {
    if (!this.gameSettings.TokenPowerBall.isVisible || !this.gameSettings.Mini.token) this.$router.push("/")
    
    this.getInitInfo()
  },
  mounted() {
		this.$store.commit('SET_CURRENTPAGENAME', 'Mini-TokenPowerBall')
    this.initframe()
    ...
    let levelSetting = this.gameSettings.TokenPowerBall.levelSetting[this.gameSettings.TokenPowerBall.levelSetting.findIndex(setting => setting.level == userLevel)]

    this.isBetAvailable = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.TokenPowerBall.gameStatus_auto | this.gameSettings.TokenPowerBall.gameStatus_manual)
    this.isCheck = !Boolean(this.gameSettings.gameStatus_socket | this.gameSettings.TokenPowerBall.gameStatus_manual)
    ...
    // 미니게임 새 회차정보 패치
    mainService.off('miniGameTokenPowerBallRound'),
    mainService.on('miniGameTokenPowerBallRound', ( currentGameInfo ) => {
      if(currentGameInfo) {
    ...
    // 회차시작이벤트
    mainService.off('miniGameTokenPowerBallTime')
    mainService.on('miniGameTokenPowerBallTime', (state) => {
      this.remainMins = 4
      this.remainSecs = 59
    })
    ...
    // 배팅내역 정산후 결과 패치
    mainService.off('miniBetLogTokenPowerBall')
    mainService.on('miniBetLogTokenPowerBall', (betLog) => {
  ...
  methods: {
    ...
    onClickBetButton(betType, odds) {
      ...
      let data = {
        ...
        leagueName: "토큰파워볼",
        betTypeName: "토큰파워볼-" + this.currentGameInfo.round + " (" + this.currentGameInfo.times + ") 회차",
    ...
    // span 얻기
    getSpan() {
      if (this.gameSettings.TokenPowerBall.canBetNumber) {
