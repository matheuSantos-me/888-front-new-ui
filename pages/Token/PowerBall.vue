              ...
              <el-row v-if="betType === 0">
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name" :class="{'height-99': !gameSettings.PowerBall.canBetNumber}">
                      {{gameSettings.PowerBall.canBetMix ? '파워볼' : '파워볼 홀짝'}}
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-odd', gameSettings.PowerBall.powerBallOdds)">
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-even', gameSettings.PowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.PowerBall.powerBallOdds | filterOdds()}}</el-row>
                ...
                <el-row v-if="!gameSettings.PowerBall.canBetNumber" class="mini-bet-row">
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-under', gameSettings.PowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.PowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('power-over', gameSettings.PowerBall.powerBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.PowerBall.powerBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">4.5</el-row>
                    </div>
                ...
                <el-row class="mini-bet-row">
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-odd', gameSettings.PowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.PowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/odd.png'"></el-row>
                    </div>
                  </el-col>
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-even', gameSettings.PowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.PowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/even.png'"></el-row>
                    </div>
                  </el-col>
                ...
                <el-row v-if="!gameSettings.PowerBall.canBetNumber" class="mini-bet-row">
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-under', gameSettings.PowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.PowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/under.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">72.5</el-row>
                    </div>
                  ...
                  <el-col :span="getSpan()">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-over', gameSettings.PowerBall.normalBallOdds)">
                      <el-row class="mini-bet-odds-value">{{gameSettings.PowerBall.normalBallOdds | filterOdds()}}</el-row>
                      <el-row class="m-t-12"><img class="mini-bet-img" :src="'/image/mini/over.png'"></el-row>
                      <el-row class="f-w-700 mini-bet-base">72.5</el-row>
                    </div>
                ...
                <el-row class="mini-bet-row">
                  <el-col :span="isMobile ? 24 : 4">
                    <div class="mini-bet-type-name word-keep" :class="{'height-99': !gameSettings.PowerBall.canBetNumber}">
                      일반볼 구간별
                    </div>
                  </el-col>
                  <el-col :class="isMobile ? 'width-33pro' : 'width-27pro'">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-big', gameSettings.PowerBall.normalBallSize.high)">
                      ...
                      <img class="float-left mini-bet-img-size m-l-1" :class="{'m-t-8': !gameSettings.PowerBall.canBetNumber}" :src="'/image/mini/big.png'">
                    </div>
                  </el-col>
                  <el-col :class="isMobile ? 'width-33pro' : 'width-27pro'">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-middle', gameSettings.PowerBall.normalBallSize.normal)">
                      ...
                      <img class="float-left mini-bet-img-size m-l-1" :class="{'m-t-8': !gameSettings.PowerBall.canBetNumber}" :src="'/image/mini/middle.png'">
                    </div>
                  </el-col>
                  <el-col :class="isMobile ? 'width-33pro' : 'width-27pro'">
                    <div class="mini-bet-button" :class="[{'height-99': !gameSettings.PowerBall.canBetNumber}, `mini-bet-button-${themeType}`]" @click="onClickBetButton('normal-small', gameSettings.PowerBall.normalBallSize.low)">
                      ...
                      <img class="float-left mini-bet-img-size m-l-1" :class="{'m-t-8': !gameSettings.PowerBall.canBetNumber}" :src="'/image/mini/small.png'">
                    </div>
                  </el-col>
                </el-row>
                <el-row v-if="gameSettings.PowerBall.canBetNumber" class="mini-bet-row">
