        ...
        <div class="panel-collapse collapse in playerbox3 minibg">
          <div id="mini-game-frame-container">
            <div id="mini-game-frame-container-in">
              <iframe scrolling="no" frameborder="0" style="width: 1000px; height: 800px; margin:0px 0px 0px 0px; z-index: 1; border: none;" 
                allowFullScreen="true" src="http://api.tgame365.com/api/?gtype=roulette&uid=1245&hash=MD5(Agent_ID|API_Key|UID)"></iframe>
            </div>
          </div>
          <!-- 로크 -->
